-- /application-track-portlet/sql/oracle/application-track-admin-portlet-create.sql
--

-- Creates application-track admin portlet
...
begin
  ...
  select datasource_id into ds_id
    ...
    where name = ''application_track_admin_portlet'';
